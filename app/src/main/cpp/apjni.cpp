...
extern "C" {
    ...
    Java_me_hidden_hidden_Natives_nativeReady(JNIEnv *env, jobject /* this */, jstring superKey)
    {
    ...
    JNIEXPORT jlong JNICALL Java_me_hidden_hidden_Natives_nativeKernelPatchVersion(JNIEnv *env, jobject /* this */,
                                                                                jstring superKey)
    {
        if (!superKey) [[unlikely]] {
            LOGE("Super Key is null!");
    ...
    JNIEXPORT jint JNICALL Java_me_hidden_hidden_Natives_nativeSu(JNIEnv *env, jobject /* this */, jstring superKey,
    ...
    JNIEXPORT jlong JNICALL Java_me_hidden_hidden_Natives_nativeThreadSu(JNIEnv *env, jobject /* this */, jstring superKey,
    ...
    JNIEXPORT jint JNICALL Java_me_hidden_hidden_Natives_nativeSuNums(JNIEnv *env, jobject /* this */, jstring superKey)
    {
        if (!superKey) [[unlikely]] {
            LOGE("Super Key is null!");
            return -EINVAL;
    ...
    JNIEXPORT jint JNICALL Java_me_hidden_hidden_Natives_nativeSetUidExclude(JNIEnv *env, jobject /* this */, jstring superKey, jint uid, jint exclude)
    {
        if (!superKey) [[unlikely]] {
            LOGE("Super Key is null!");
            return -EINVAL;
    ...
    JNIEXPORT jint JNICALL Java_me_hidden_hidden_Natives_nativeGetUidExclude(JNIEnv *env, jobject /* this */, jstring superKey, uid_t uid)
    {
        if (!superKey) [[unlikely]] {
            LOGE("Super Key is null!");
            return -EINVAL;
    ...
    JNIEXPORT jintArray JNICALL Java_me_hidden_hidden_Natives_nativeSuUids(JNIEnv *env, jobject /* this */,
                                                                         jstring superKey)
    {
        if (!superKey) [[unlikely]] {
            LOGE("Super Key is null!");
    ...
    JNIEXPORT jobject JNICALL Java_me_hidden_hidden_Natives_nativeSuProfile(JNIEnv *env, jobject /* this */,
                                                                          jstring superKey, jint uid)
    {
        ...
        jclass cls = env->FindClass("me/hidden/hidden/Natives$Profile");
    ...
    JNIEXPORT jlong JNICALL Java_me_hidden_hidden_Natives_nativeLoadKernelPatchModule(JNIEnv *env, jobject /* this */,
                                                                                    jstring superKey,
                                                                                    jstring modulePath,
                                                                                    jstring jargs)
    {
    ...
    JNIEXPORT jobject JNICALL Java_me_hidden_hidden_Natives_nativeControlKernelPatchModule(JNIEnv *env, jobject /* this */,
                                                                                         jstring superKey,
                                                                                         jstring modName,
                                                                                         jstring jctlargs)
    {
        ...
        jclass cls = env->FindClass("me/hidden/hidden/Natives$KPMCtlRes");
        jmethodID constructor = env->GetMethodID(cls, "<init>", "()V");
    ...
    JNIEXPORT jlong JNICALL Java_me_hidden_hidden_Natives_nativeUnloadKernelPatchModule(JNIEnv *env, jobject /* this */,
                                                                                      jstring superKey,
                                                                                      jstring modName)
    {
        if (!superKey) [[unlikely]] {
    ...
    JNIEXPORT jlong JNICALL Java_me_hidden_hidden_Natives_nativeKernelPatchModuleNum(JNIEnv *env, jobject /* this */,
                                                                                   jstring superKey)
    {
        if (!superKey) [[unlikely]] {
            LOGE("Super Key is null!");
    ...
    JNIEXPORT jstring JNICALL Java_me_hidden_hidden_Natives_nativeKernelPatchModuleList(JNIEnv *env, jobject /* this */,
                                                                                      jstring superKey)
    {
        if (!superKey) [[unlikely]] {
            LOGE("Super Key is null!");
    ...
    JNIEXPORT jstring JNICALL Java_me_hidden_hidden_Natives_nativeKernelPatchModuleInfo(JNIEnv *env, jobject /* this */,
                                                                                      jstring superKey,
                                                                                      jstring modName)
    {
        if (!superKey) [[unlikely]] {
    ...
    JNIEXPORT jlong JNICALL Java_me_hidden_hidden_Natives_nativeGrantSu(JNIEnv *env, jobject /* this */, jstring superKey,
    ...
    JNIEXPORT jlong JNICALL Java_me_hidden_hidden_Natives_nativeRevokeSu(JNIEnv *env, jobject /* this */, jstring superKey,
                                                                       jint uid)
    {
        if (!superKey) [[unlikely]] {
            LOGE("Super Key is null!");
    ...
    JNIEXPORT jstring JNICALL Java_me_hidden_hidden_Natives_nativeSuPath(JNIEnv *env, jobject /* this */, jstring superKey)
    {
        if (!superKey) [[unlikely]] {
            LOGE("Super Key is null!");
            return nullptr;
    ...
    JNIEXPORT jboolean JNICALL Java_me_hidden_hidden_Natives_nativeResetSuPath(JNIEnv *env, jobject /* this */,
...
JNIEXPORT jboolean JNICALL Java_me_hidden_hidden_Natives_nativeGetSafeMode(JNIEnv *env, jobject /* this */,
                                                                         jstring superKey)
    {
        if (!superKey) [[unlikely]] {
            LOGE("Super Key is null!");
